...
export default function WalkingClient() {
  ...
  const fetchWalking = async () => {
    try {
      ...
      const response = await fetch(`https://api.india-jobs.in/api/v1/walking?${params.toString()}`);
              ...
              <>
                ...
                <div className="mb-6">
                  <p className="text-gray-600">
                    Showing {walking.length} of {pagination.totalItems} walking opportunity
                  </p>
                </div>
