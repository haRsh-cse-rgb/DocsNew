...
export default function BulkUploadSarkariJobs() {
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('https://api.india-jobs.in/api/v1/admin/sarkari-jobs/bulk', formData, {
        headers: { 
      ...
      toast.success(`Upload completed! ${response.data.successful} government jobs created successfully.`);
    } catch (error: any) {
...
Bank PO,IBPS,02/2024,2024-02-01,2024-03-01,2024-07-01,₹850,5000 vacancies,Graduate degree required,https://ibps.in,https://ibps.in/notification,https://ibps.in/apply,https://ibps.in/results`;
    ...
    a.href = url;
    a.download = 'sarkari-jobs-template.csv';
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Bulk Upload Government Jobs</h1>
              <p className="text-gray-600">Upload multiple government jobs via Excel or CSV file</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <form onSubmit={handleUpload} className="space-y-6">
              ...
              >
                ...
                <span>{uploading ? 'Uploading...' : 'Upload Government Jobs'}</span>
              </button>
            </form>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Use our template to ensure your government job data is formatted correctly.
              </p>
              <button
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-600">postName</span>
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">officialWebsite</span>
                  <span className="text-red-600">Required</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">notificationLink</span>
                  <span className="text-red-600">Required</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">advertisementNo</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">applicationStart</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">applicationEnd</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">applicationFee</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">vacancyDetails</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">applyLink</span>
                  <span className="text-gray-500">Optional</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">resultLink</span>
                  <span className="text-gray-500">Optional</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                ...
                <li>• All links should be valid URLs</li>
                <li>• Organization should be from the predefined list</li>
                <li>• Maximum file size: 10MB</li>
                <li>• Supported organizations: UPSC, SSC, IBPS, SBI, Railway, Defense, Teaching, State PSC, Other</li>
              </ul>
            </div>
          </div>
        </div>
