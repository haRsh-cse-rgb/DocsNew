...
export default function WalkingCard({ walking }: WalkingCardProps) {
  ...
  const handleCopyLink = async () => {
    const shareText = `${walking.company} is hiring for ${walking.title} — ${walking.location}. 
Walk-in Date: ${walking.date}, Time: ${walking.time}.
Apply here: ${window.location.origin}/walkins/${walking.id}`;
      ...
      <div className="mt-auto flex items-center justify-between gap-2">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="inline-flex items-center px-3 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 text-sm font-medium rounded-lg transition-colors duration-200"
          >
