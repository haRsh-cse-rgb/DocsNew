...
export default function CategoryJobsClient({ category }: CategoryJobsClientProps) {
  ...
  const fetchJobs = async (page = 1) => {
    try {
      ...
      const response = await axios.get(`https://api.india-jobs.in/api/v1/jobs?${paramsObj.toString()}`);
