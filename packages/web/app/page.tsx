...
import Footer from './components/Footer';
import LoadingSpinner from './components/LoadingSpinner';
import WhatsAppModal from './components/WhatsAppModal'; // ✅ New client component

export const metadata: Metadata = {
  title: 'India Jobs - Find Your Dream Job | Best Job Opportunities in India',
  description:
    'Discover the best job opportunities across India. Find private sector jobs, government positions, internships, and walk-in interviews. Your trusted platform for career growth.',
  keywords:
    'jobs in India, careers, employment, job search, government jobs, sarkari jobs, internships, walk-ins, private sector jobs, remote jobs, fresher jobs',
  authors: [{ name: 'India Jobs Team' }],
  openGraph: {
    title: 'India Jobs - Find Your Dream Job',
    description:
      'Discover the best job opportunities across India. Find private sector jobs, government positions, internships, and walk-in interviews.',
    type: 'website',
    locale: 'en_US',
    url: 'https://india-jobs.in',
    siteName: 'India Jobs',
